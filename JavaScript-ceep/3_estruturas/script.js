...
// Laço de Repetição (WHILE, DO WHILE e FOR)
console.log("-----------------------------");
//WHILE:
let contador = 10
...
while(contador > 0){
    ...
    //Todo laço de repetição precisa controlar a situação de parada para forçar sar do laço
...
let numeroTabuada = promp('Informe um número para ver a sua tabuada: ')

for(let i = 1; i < 11; i ++){
    resutado = MDNReference
}
